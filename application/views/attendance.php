...
<div class="container">
    ...
    <form method="POST" action="http://192.168.0.200/Vipin/AdminUser/index.php/Connector/photo_capture">
        <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-12 text-center">
                <br/>
                <button onclick="timeInOut()" class="btn btn-success">Submit</button>
            </div>
        </div>
    </form>
</div>
